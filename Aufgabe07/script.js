...
(function (Aufgabe07) {
    ...
    async function generateArtikle() {
        await Aufgabe07.handleData("artikel.json");
        machmeineseite();
    }
    Aufgabe07.generateArtikle = generateArtikle;
    let summe = 0;
    ...
    function machmeineseite() {
        ...
        for (let i = 0; i < Aufgabe07.artikelArray.length; i++) {
            ...
            function handleClickStorage(_event) {
                warenKorbArtikel.push(Aufgabe07.artikelArray[i]);
                localStorage.setItem("artikel_name" + (warenKorbArtikel.length - 1), Aufgabe07.artikelArray[i].name);
                localStorage.setItem("artikel_preis" + (warenKorbArtikel.length - 1), Aufgabe07.artikelArray[i].preis.toString());
                localStorage.setItem("artikel_beschreibung" + (warenKorbArtikel.length - 1), Aufgabe07.artikelArray[i].beschreibung);
                localStorage.setItem("artikel_bild" + (warenKorbArtikel.length - 1), Aufgabe07.artikelArray[i].bild);
